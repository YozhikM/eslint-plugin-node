...
const rule = require("../../../lib/rules/no-unsupported-ecma-features")
...
function fixture(name) {
    return path.resolve(
        __dirname,
        "../../fixtures/no-unsupported-ecma-features",
        name
    )
}
